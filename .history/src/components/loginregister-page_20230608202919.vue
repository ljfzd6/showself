          ...
          <div id="section2" class="section-w3ls">
            ...
            <article>
              <form action="#" method="post">
                ...
                <div class="input" style="height: 5px;">
                  <input type="radio" name="radios" id="radio1" value="1" v-model="param" style="height: 5px;">
                  <label for="radio1" style="height: 5px;">Option 1</label>
                </div>
                <div class="input" style="height: 5px;">
                  <input type="radio" name="radios" id="radio2" value="2" v-model="param" style="height: 5px;">
                  <label for="radio2" style="height: 5px;">Option 2</label>
                </div>
